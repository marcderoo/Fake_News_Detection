...
X_train_tfidf, X_test_tfidf, vectorizer = extract_tfidf_features(test_data["text"], test_data["text"])
...
ml_models = ["SVM", "RandomForest", "LogisticRegression", "GradientBoosting", "AdaBoost", "NeuralNetwork"]
